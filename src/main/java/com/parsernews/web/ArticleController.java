    ...
    public record ArticleListResponse(
        ...
        static ArticleListResponse from(
            ...
            return new ArticleListResponse(
                    ...
                    event == null ? null : event.getTargetTicker(),
                    event == null ? null : event.getTargetCik(),
                    event != null && event.isTargetPublicCompany(),
                    event == null ? CompanyMatchConfidence.NONE : event.getTargetMatchConfidence(),
                    dealTerms.buyerCompany(),
                    event == null ? null : event.getBuyerTicker(),
                    event == null ? null : event.getBuyerCik(),
                    event != null && event.isBuyerPublicCompany(),
                    event == null ? CompanyMatchConfidence.NONE : event.getBuyerMatchConfidence(),
                    event == null ? null : event.getCompanyEnrichmentWarnings(),
